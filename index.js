...
img.src =
  "https://coronadotimes.com/wp-content/uploads/2019/06/secret.life_.pets_.movie_-e1541608557369.jpeg";
...
function addItem() {
  ...
  for (const [key, value] of Object.entries(
    JSON.parse(JSON.stringify(avObject.petData))
  )) {
...
function addRequest() {
  ...
  lbl1.innerHTML =
    "<strong>Request Pet Types :</strong> (can add multiple pets with comma without space and starting with Capital letter.) <br>Eg : Dog,Cat,Parrot";
  let inp1 = document.createElement("input");
  inp1.classList.add("form-control");
  inp1.id = "rq";
  inp1.required = true;
